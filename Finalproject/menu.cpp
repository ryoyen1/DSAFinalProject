////
//// Created by Ryo yenata on 6/28/2019.
////
//#include "menu.h"
//void Menu::writefile(){
//    ofstream contactfile;
//    string fn,ln,p,a;
//    contactfile.open("contactbook.txt");
//    contactfile << "Contacts" << endl << endl << endl;
//    for (int i = 0; i < Cbook.size();i++){
//        fn = Cbook[i].getFname();
//        ln = Cbook[i].getLname();
//        p = Cbook[i].getPhonenumber();
//        a = Cbook[i].getAddress();
//        contactfile << fn << " " << ln << " " << p << " " << a << endl;
//    }
//}
//
//
